                            ...
                            <div class="row align-items-center slider-animated-1">
                                ...
                                <div class="col-lg-7 col-md-6">
                                    <div class="single-slider-img single-slider-img-1">
                                        <img class="animated slider-1-1" src="{{ asset('assets/imgs/slider') }}/{{ $item->image }}" alt="{{ $item->title }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                    <div class="product-cart-wrap mb-30">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <h2><a href="{{ route('product.details',['slug'=>$item->slug])}}">{{ $item->name }}</a></h2>
                    ...
                    <div class="carausel-6-columns" id="carausel-6-columns">
                        ...
                        <div class="card-1">
                            <figure class=" img-hover-scale overflow-hidden">
                                <a href="{{ route('product.category',['slug'=>$item->slug]) }}"><img src="{{ asset('assets/imgs/categories') }}/{{ $item->image }}" alt="{{ $item->name }}"></a>
                            </figure>
                            <h5><a href="{{ route('product.category',['slug'=>$item->slug]) }}">{{ $item->name }}</a></h5>
                        </div>
                        @endforeach
                    </div>
                </div>
                        ...
                        <div class="product-cart-wrap small hover-up">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="{{ route('product.details',['slug'=>$item->slug]) }}">
                                        <img class="default-img" src="{{ asset('assets/imgs/products') }}/{{ $item->image }}" alt="{{ $item->name }}">
                                        <img class="hover-img" src="{{ asset('assets/imgs/products') }}/{{ $item->imgae }}" alt="{{ $item->name }}">
                                    </a>
                                </div>
                                <div class="product-action-1">
