                                ...
                                <div class="sort-by-cover mr-10">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a class="{{ $pageSize==32 ? 'active':'' }}" href="#" wire:click.prevent="changePageSize(35)">35</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a class="{{ $orderBy== 'Sorting By Newness' ? 'active':'' }}" href="#" wire:click.prevent="changeOrderBy('Sorting By Newness')">Sorting By Newness</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-action-1 show">
                                            {{-- add love or wishlist --}}
                                            @if ($witems->contains($product->id))
                                                <a aria-label="Add To Wishlist" class="action-btn hover-up wishlisted" href="#" wire:click.prevent="removeFromWishlist({{ $product->id }})"><i class="fi-rs-heart"></i></a>
                                            @else
                        ...
                        <div class="widget-category mb-30">
                            ...
                            <ul class="categories">
                                @foreach ($categories as $item)
                                    <li><a href="{{ route('product.category',['slug'=>$item->slug]) }}">{{ $item->name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <!-- Fillter By Price -->
...
{{-- scripts for filter range of price --}}
@push('scripts')
<script>
